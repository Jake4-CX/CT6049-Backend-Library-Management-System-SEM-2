...
@Path("/librarian/average/borrowed-books/quarter")
public class AverageBooksBorrowedLastQuarterResource {

    @GET
    @RestrictedRoles({User.Role.LIBRARIAN})
    @Produces(MediaType.APPLICATION_JSON)
    public Response getAverageBooksBorrowedLastQuarter() {
        LibrarianService service = new LibrarianService();
        Map<String, Object> response = new HashMap<>();

        try {
            double result = service.getAverageBooksBorrowedLastQuarter();
